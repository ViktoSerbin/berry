(() => {
    ...
    function initSliders() {
        if (document.querySelector(".sliders__slider")) new core(".sliders__slider", {
            modules: [ Thumb ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".related-products__slider")) new core(".related-products__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            speed: 800,
            navigation: {
                prevEl: ".related-products__controlls .swiper-button-prev",
                nextEl: ".related-products__controlls .swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
    ...
    if (clearFilterBtn && filterItemCategory) clearFilterBtn.addEventListener("click", (() => {
    ...
    document.addEventListener("click", (e => {
        const targetElement = e.target;
        if (targetElement.closest(".filter-active__delete")) targetElement.closest(".filter-active__item").remove();
        if (targetElement.closest(".filters-products__filter-btn")) {
            const bodyProductsItems = document.querySelector(".body-products__items");
            if (bodyProductsItems) bodyProductsItems.classList.toggle("active-filters");
        }
    }));
    window["FLS"] = true;
    isWebp();
